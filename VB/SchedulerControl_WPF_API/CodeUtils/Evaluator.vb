...
Namespace SchedulerControl_WPF_API
    Public MustInherit Class ExampleCodeEvaluator
        ...
        Protected Friend Function CompileAndRun(ByVal linesOfCode() As String, ByVal evaluationParameter As Object) As Boolean
            ...
            Dim referencesDX() As String = { AssemblyInfo.SRAssemblyData, GetModuleAssembly(), AssemblyInfo.SRAssemblyOfficeCore, AssemblyInfo.SRAssemblyPrintingCore, AssemblyInfo.SRAssemblyPrinting, AssemblyInfo.SRAssemblyDocs, AssemblyInfo.SRAssemblyUtils, AssemblyInfo.SRAssemblyXpfScheduler, AssemblyInfo.SRAssemblyXpfCore }
    ...
    Public Class RichEditCSExampleCodeEvaluator
        ...
        Private Const codeStart_Renamed As String = "using System;" & ControlChars.CrLf & "using DevExpress.XtraScheduler;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Drawing;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Services;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Native;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Xml;" & ControlChars.CrLf & "using DevExpress.Xpf.Scheduler;" & ControlChars.CrLf & "using System.Windows.Media;" & ControlChars.CrLf & "using DevExpress.Utils;" & ControlChars.CrLf & "using System.IO;" & ControlChars.CrLf & "using System.Diagnostics;" & ControlChars.CrLf & "using System.Xml;" & ControlChars.CrLf & "using System.Data;" & ControlChars.CrLf & "using System.Collections.Generic;" & ControlChars.CrLf & "using System.Linq;" & ControlChars.CrLf & "using System.Globalization;" & ControlChars.CrLf & "namespace RichEditCodeResultViewer { " & ControlChars.CrLf & "public class ExampleItem { " & ControlChars.CrLf & "        public static void Process(SchedulerControl scheduler) { " & ControlChars.CrLf & ControlChars.CrLf
        ...
        Private Const codeEnd_Renamed As String = "       " & ControlChars.CrLf & " }" & ControlChars.CrLf & "    }" & ControlChars.CrLf
    ...
    Public Class RichEditVbExampleCodeEvaluator
        ...
        Private Const codeStart_Renamed As String = "Imports Microsoft.VisualBasic" & ControlChars.CrLf & "Imports System" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Drawing" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Services" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Native" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Xml" & ControlChars.CrLf & "Imports DevExpress.Xpf.Scheduler" & ControlChars.CrLf & "Imports System.Windows.Media" & ControlChars.CrLf & "Imports DevExpress.Utils" & ControlChars.CrLf & "Imports System.IO" & ControlChars.CrLf & "Imports System.Diagnostics" & ControlChars.CrLf & "Imports System.Xml" & ControlChars.CrLf & "Imports System.Data" & ControlChars.CrLf & "Imports System.Collections.Generic" & ControlChars.CrLf & "Imports System.Globalization" & ControlChars.CrLf & "Namespace RichEditCodeResultViewer" & ControlChars.CrLf & "	Public Class ExampleItem" & ControlChars.CrLf & "		Public Shared Sub Process(ByVal scheduler As SchedulerControl)" & ControlChars.CrLf & ControlChars.CrLf
