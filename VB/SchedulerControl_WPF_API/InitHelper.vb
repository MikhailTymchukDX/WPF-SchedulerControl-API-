    ...
    Public Class InitHelper
        ...
        Public Shared Sub GenerateEvents(ByVal eventList As BindingList(Of CustomAppointment), ByVal resources As BindingList(Of CustomResource))
            ...
            For i As Integer = 0 To count - 1
                ...
                subjPrefix = subjPrefix & Environment.NewLine & "Next Line" & Environment.NewLine & "Middle Line" & Environment.NewLine
                ...
                eventList.Add(CreateEvent(subjPrefix & "Last line", resource.ResID, 2, 5))
                eventList.Add(CreateEvent(subjPrefix & "Last line", resource.ResID, 3, 6))
                eventList.Add(CreateEvent(subjPrefix & "Last line", resource.ResID, 0, 10))
            Next i
        End Sub
